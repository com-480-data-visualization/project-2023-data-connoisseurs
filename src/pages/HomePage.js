...
function Card({ title, text }) {
  return (
    ...
    <div className="block max-w-sm flex-1 rounded-lg border border-gray-200 bg-primary p-6 shadow hover:bg-secondary ">
      <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        {title}
      </h5>
      <p className="font-normal text-gray-700 dark:text-gray-300">{text}</p>
    </div>
  );
}
