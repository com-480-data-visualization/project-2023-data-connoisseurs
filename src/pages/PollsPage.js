...
import {GroupClass, ItemClass} from "../components/MapControls";
...
export function PollsPage() {
    const [pollSource, setPollSource] = React.useState(PollSource.Eurovisionworld)
    return (
        <div className="polls-page">
            ...
            >
                <ToggleGroup.Item className={ItemClass} value={PollSource.Eurovisionworld}>
                    Eurovisionworld
                </ToggleGroup.Item>
                <ToggleGroup.Item className={ItemClass} value={PollSource.OGAE}>
                    OGAE
                </ToggleGroup.Item>
            </ToggleGroup.Root>
            ...
            <div className="two-column-layout">
                ...
                <div className="right-column">
                    <VictoryChart
                        theme={VictoryTheme.material}
                    >
                        <VictoryAxis tickValues={[2016, 2017, 2018, 2019, 2021]} tickFormat={["2016", "2017", "2018", "2019", "2021"]}/>
